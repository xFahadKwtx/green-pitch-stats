...
const dict = {
  en: {
    ...
    "games.date": "Date",
    "games.day": "Day",
    "games.empty": "No bookings published for this week yet.",
    ...
    "rewards.challenge.body":
      "Every position has its own special challenge. Complete your position challenge and get a 50% discount on the next match only.",
    "rewards.challenge.soon": "Position challenges will be announced soon.",
    "rewards.bring": "Bring a Player Reward",
    "rewards.bring.body": "Bring another player and get a 10% discount.",
  ...
  ar: {
    ...
    "games.date": "التاريخ",
    "games.day": "اليوم",
    "games.empty": "لا توجد حجوزات منشورة لهذا الأسبوع بعد.",
    ...
    "rewards.mvp": "مكافأة أفضل لاعب في المباراة",
    "rewards.mvp.body": "أفضل لاعب في المباراة يلعب المباراة التالية فقط مجاناً.",
    "rewards.potm": "مكافأة لاعب الشهر",
    "rewards.potm.body": "لاعب الشهر يحصل على خصم 50% لمدة شهر كامل.",
    "rewards.challenge": "مكافأة تحدي المركز",
    "rewards.challenge.body":
      "كل مركز له تحدٍ خاص. أكمل تحدي مركزك واحصل على خصم 50% على المباراة التالية فقط.",
    "rewards.challenge.soon": "سيتم الإعلان عن تحديات المراكز قريباً.",
    "rewards.bring": "مكافأة إحضار لاعب",
    "rewards.bring.body": "أحضر لاعباً آخر واحصل على خصم 10%.",
