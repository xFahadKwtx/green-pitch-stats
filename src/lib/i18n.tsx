...
const dict = {
  en: {
    ...
    "feedback.title": "Send us any suggestion or complaint",
    "feedback.privacy":
      "Your name and any details about you will never appear (you may write your name inside the message).",
    "feedback.label": "Your message",
    "feedback.placeholder": "Write your suggestion or complaint here",
    "feedback.send": "Send",
    "feedback.sending": "Sending…",
    "feedback.success": "Your message was sent anonymously. Thank you.",
    "feedback.error.empty": "Please write a message before sending.",
    "feedback.error.tooLong": "Your message is too long. Please shorten it.",
    "feedback.error.rate": "Too many messages sent. Please try again a little later.",
    "feedback.error.failed": "The message could not be sent right now. Please try again later.",
    "feedback.error.unconfigured":
      "Sending is not available yet. Please contact us on WhatsApp for now.",
  ...
  ar: {
    ...
    "feedback.title": "ارسل لنا اي اقتراح او شكوى",
    "feedback.privacy": "لن يظهر اسمك او اي بيانات عنك (بإمكانك كتابة اسمك في الرسالة)",
    "feedback.label": "رسالتك",
    "feedback.placeholder": "اكتب اقتراحك او شكواك هنا",
    "feedback.send": "إرسال",
    "feedback.sending": "جارٍ الإرسال…",
    "feedback.success": "تم إرسال رسالتك بشكل مجهول. شكراً لك.",
    "feedback.error.empty": "الرجاء كتابة رسالة قبل الإرسال.",
    "feedback.error.tooLong": "الرسالة طويلة جداً. الرجاء تقصيرها.",
    "feedback.error.rate": "تم إرسال رسائل كثيرة. الرجاء المحاولة بعد قليل.",
    "feedback.error.failed": "تعذّر إرسال الرسالة حالياً. الرجاء المحاولة لاحقاً.",
    "feedback.error.unconfigured":
      "الإرسال غير متاح حالياً. الرجاء التواصل معنا عبر واتساب في الوقت الحالي.",
